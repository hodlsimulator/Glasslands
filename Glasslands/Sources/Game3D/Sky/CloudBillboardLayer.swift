...
//  grouped into clusters. Correct perspective, no lat‑long stretching.
//
...
enum CloudBillboardLayer {
    ...
    static func makeAsync(
        ...
        Task.detached(priority: .userInitiated) {
            let specs = buildSpecs(clusterCount: clusterCount,
    ...
    private static func buildSpecs(
        ...
        for centre in centres {
            ...
            for _ in 0..<count {
                ...
                let aidx  = Int(rand(&s) * 1024) // reduced with modulo against atlas count later
