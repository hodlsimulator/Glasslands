...
enum CloudBillboardLayer {
    static func makeAsync(
        ...
        Task.detached(priority: .userInitiated) {
            ...
            let farPts    = CloudBillboardPlacement.poissonAnnulus(farC,    r0: rFar0,    r1: rFar1,    minSepNear: 380, minSepFar: 560, seed: &s)
            let ultraPts  = CloudBillboardPlacement.poissonAnnulus(ultraC,  r0: rUltra0,  r1: rUltra1,  minSepNear: 360, minSepFar: 520, seed: &s)
            ...
            for p in nearPts {
                specs.append(
                    CloudBillboardPlacement.buildCluster(
